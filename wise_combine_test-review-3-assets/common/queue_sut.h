#ifndef REVIEW_QUEUE_SUT_H
#define REVIEW_QUEUE_SUT_H
#ifndef MUTANT
#define MUTANT 0
#endif
/* Identical implementation for every project. Never put assertions in this file.
   Initial state is closed/empty. One mutant at a time; MUTANT=0 is clean. */
