...
These fixes are covered by fresh iteration 16 automated evidence. Final
...
6. Artifact hashes and source commit in `evidence/iter-16/summary.json` and
   `manifest.json`.

Independent review must also be completed for the same frozen commit:
