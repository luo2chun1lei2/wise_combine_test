...
COMMON=/home/workspace_data/works/myprojects/wise_combine_test.evaluate‌/wise_combine_test-review-3-assets/common
...
for scenario in 1 2 3 4 5 6; do
  for mutant in 0 "$scenario"; do
    for repeat in 1 2; do
      ...
      mkdir -p "$out"
      set +e
      timeout -k 1 10 "$PROJECT/build/wise-combine" run "$ROOT/q${scenario}.json" \
