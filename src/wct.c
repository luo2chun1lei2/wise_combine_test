...
int wct_parse_file(const char *path, wct_state_graph *s, wct_relation_graph *r, char *err, size_t errlen) {
    ...
    FILE *f = fopen(path,"r"); char line[2048]; unsigned schema=0;
    size_t ln=0, schema_line=0, state_graph_line=0, relation_graph_line=0;
    int schema_seen=0, state_graph_seen=0, relation_graph_seen=0;
